...
export async function GET(request) {
  try {
    ...
    if (!code) {
      console.error("AUTH CALLBACK SEM CODE")
    ...
    console.error("ERRO INESPERADO CALLBACK AUTH:", error)
    return NextResponse.redirect(getRequestSiteUrl(request, "/admin/login?error=unexpected_callback"))
  }
}
