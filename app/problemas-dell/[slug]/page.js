...
import { problemasConteudo } from "../../../data/problemasConteudo"
...
export function generateMetadata({ params }) {
  ...
  return {
    ...
    description: `Assistência técnica especializada para ${modeloData.nome} ${problemaData.nome} no bairro ${bairroData.nome}, Zona Norte de São Paulo. Diagnóstico profissional, reparo de placa-mãe, troca de SSD e upgrade de memória.`
...
export default function Page({ params }) {
  ...
  const problemaData = problemas[problema]
  const bairroData = bairros[bairro]
  const conteudo = problemasConteudo[problema]
  ...
  const schema = {
    ...
    serviceType: `Reparo ${modeloData.nome}`,
        ...
        <div className="flex flex-col md:flex-row gap-10">
          ...
          <div className="flex-1">
            ...
            <p className="mt-4 text-gray-700">
              ...
              Nossa assistência técnica realiza reparo de placa-mãe,
              troca de SSD, upgrade de memória RAM, limpeza interna
              e manutenção preventiva em notebooks Dell.
